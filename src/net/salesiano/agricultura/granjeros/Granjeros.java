...
public class Granjeros extends Thread {
    ...
    public Granjeros(String nombre, int cantidadDeVerduras) {
        this.nombre = nombre;
    ...
    // Se multiplican estos dos y dara como resultado un nuumero decimal
    // en el rango de la longitud del array: Si el array tiene como max 15 
    // el resultado podria ser 7.345.
    // y el (int) lo que hace es convertir ese resultado 7.345 en 7 basicamente lo trunca
